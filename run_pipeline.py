...
def main():
    ...
    target_indices = [3, 9, 13, 22, 25, 31, 36, 37, 40, 42, 59, 63, 73, 75, 78, 83, 85, 88, 94]
    test_subset = [item for idx, item in enumerate(val_dataset) if idx in target_indices or item.get("binary_label") == "multiple"]
