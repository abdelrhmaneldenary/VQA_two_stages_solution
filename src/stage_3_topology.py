...
class TopologicalEvaluator:
    def __init__(self, w1_ciou=0.4, w2_conflict=0.6, threshold=0.045):
        print("🚀 Initializing VizWiz Solid-Pixel Topological Evaluator (Hole-Filling)...")
    ...
    def evaluate(self, masks):
        ...
        # --- SOLID-PIXEL SEMANTIC NMS (Hole-Filling) ---
        # 1. Fill holes in all masks so parents (couches) absorb children (pillows)
        ...
        for i in sorted_indices:
            ...
            for j in kept_indices:
                ...
                # Check pure pixel containment using the solid, hole-free masks
        ...
        # Retrieve the original VizWiz-accurate masks for the survivors
